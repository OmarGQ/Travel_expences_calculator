...
public class Confirmar extends JFrame{
    ...
    String nom, des; 
    private JButton b, conf, reporte;
    java.util.Date d;
    ...
    public Confirmar(){
        ...
        conf.setFont(new Font("Arial",Font.PLAIN,40));
        ...
        ay.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent me) {
                ...
                r.setSize(590,400);
                r.setLocation(0, 0);
                r.setText("<html>Para obtener un resultado para confirmar primero debe llenar los campos vacios con la informacion que se pide y oprimir el boton de buscar para obtener un resultado y si este no ha sido confirmado aparecera un boton de confirmacion con el cual se confirmara los viaticos<html>");
    ...
    private void search(){
        ...
        dt2.setText("<html>Cantidad<br>  "+cande+"<br>  "+cancom+"<br>  "+cancen+"<br>  "+canhos+"  <br>---<br>---<br>---<html>");
    ...
    private void confirmacion(){
        String sql="update viaticos set Confirmacion=1 where Codigo_V='"+codigo_v+"'";
        try {
            Statement st = con.createStatement();
            st.execute(sql);
            reporte.setVisible(true);
